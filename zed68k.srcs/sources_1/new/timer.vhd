...
-- Engineer: 
-- 
-- Create Date: 21.10.2020 08:50:03
-- Design Name: 
...
-- 
constant BIT_DOWN_ENB   : integer := 0; -- 0=disable, 1=enabled (count down)
constant BIT_UP_ENB   : integer := 1; -- 0=disable, 1=enabled (continual count up)
...
begin 
  ...
  timer_control : process( clk, rst, cs, rw, addr, data_in, 
                         timer_ctrl, timer_term, timer_count, count_up ) 
  begin 
    ...
    if clk'event and clk = '0' then 
      ...
      if rst = '1' then 
	     ...
	     if (timer_ctrl(BIT_DOWN_ENB) = '1') then 
