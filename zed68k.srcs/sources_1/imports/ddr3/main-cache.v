...
module main_memory_control (
   ...
   wire i_valid;
   reg cache_valid, cache_wren;
   wire cache_hit, cache_complete;
   reg [15:0] cache_wr_data;
   wire [15:0] cache_data;
   wire [15:0] cache_rd_data;
    ...
    cache ram_cache ( 
    .clock(clk),
    .address(real_address),   // Address bus (Upper part not used)
    .wr_byte_mask(wr_byte_mask),
    .i_valid(cache_valid),
    .i_wren(cache_wren),      // Write enable
    .wr_data(cache_wr_data),     // Data to write
    .rd_data(cache_rd_data),      // Data to read
    .hit(cache_hit),
    .complete(cache_complete)
    );
    
    
    assign cache_data = cache_rd_data;
...
//        output [0:0]    o_valid, //active high valid
      //       wire i_valid, cache_valid, cache_wren, cache_hit, cache_complete;
//   wire [15:0] cache_rd_data, cache_wr_data;
	   ...
	   8: begin
	      if (cache_hit & cache_complete) begin
	           rd_data <= cache_data;
	           o_valid <= 1;
	           state <= 100;
          end
