...
#
# Generated by Vivado on Mon May 24 08:55:23 +0100 2021
...
# Script info
echo -e "pll.sh - Script generated by export_simulation (Vivado v2020.1 (64-bit)-id)\n"
...
simulate()
{
  xsim pll -key {Behavioral:sim_1:Functional:pll} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/serial.protoinst" -protoinst "protoinst_files/ethernetlite.protoinst" -log simulate.log
}
