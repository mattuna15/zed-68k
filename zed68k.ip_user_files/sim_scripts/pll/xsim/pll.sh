...
#
# Generated by Vivado on Thu Oct 22 13:06:17 +0100 2020
...
simulate()
{
  xsim pll -key {Behavioral:sim_1:Functional:pll} -tclbatch cmd.tcl -protoinst "protoinst_files/serial.protoinst" -protoinst "protoinst_files/write_fifo.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
