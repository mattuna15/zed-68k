...
#
# Generated by Vivado on Sat May 29 13:13:41 +0100 2021
...
simulate()
{
  xsim pll -key {Behavioral:sim_1:Functional:pll} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/serial.protoinst" -log simulate.log
}
