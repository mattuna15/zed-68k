...
#
# Generated by Vivado on Wed Sep 09 14:23:09 +0100 2020
...
simulate()
{
  xsim clk_gen -key {Behavioral:sim_1:Functional:clk_gen} -tclbatch cmd.tcl -protoinst "protoinst_files/serial.protoinst" -protoinst "protoinst_files/write_fifo.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
