...
#
# Generated by Vivado on Fri Aug 28 21:10:34 +0100 2020
...
simulate()
{
  xsim fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/write_fifo.protoinst" -protoinst "protoinst_files/debug.protoinst" -log simulate.log
}
