...
#
# Generated by export_simulation on Tue May 04 10:40:04 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './ethernetlite.sh' script.

./ethernetlite.sh -reset_run
...
./ethernetlite.sh -noclean_files

For more information on the script, please type './ethernetlite.sh -help'.
