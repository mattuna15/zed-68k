...
#
# Generated by Vivado on Mon Aug 02 22:09:51 +0100 2021
...
# Script info
echo -e "floating_point_0.sh - Script generated by export_simulation (Vivado v2020.1 (64-bit)-id)\n"
...
simulate()
{
  xsim floating_point_0 -key {Behavioral:sim_1:Functional:floating_point_0} -tclbatch cmd.tcl -protoinst "protoinst_files/fpu_design.protoinst" -log simulate.log
}
