...
#
# Generated by export_simulation on Sun Sep 06 10:07:14 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './audio_clock48.sh' script.

./audio_clock48.sh -reset_run
...
./audio_clock48.sh -noclean_files

For more information on the script, please type './audio_clock48.sh -help'.
