...
#
# Generated by export_simulation on Mon Apr 05 20:58:43 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './serial.sh' script.
...
./serial.sh -noclean_files

For more information on the script, please type './serial.sh -help'.
